...
1. From the project root, run `LIBPHONENUMBER_REF=v1.2.3 make update_metadata`, replacing the variable with whatever version you want. This should update a few files; most notably, `libPhoneNumber/NBPhoneNumberMetaData.plist`.
